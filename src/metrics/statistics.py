...
if __name__ == '__main__':
    datasets = {
        0: {
            ...
            'processed_data': np.random.random(size=(4, 100000))
        },
        1: {
            'win_check_mask': True,
            'ch_check_mask': [True, False, False, False],
            'processed_data': np.random.random(size=(4, 100000))
        }
    }

    statistics = Statistics(datasets)
    print(statistics.compute_single_win_statistics())
